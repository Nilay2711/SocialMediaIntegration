...
public class Google extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(Google.this);
                                ...
                                Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
                                    ...
                                    public void onResult(@NonNull Status status) {
                                        if(status.isSuccess()){
                                            ...
                                            Toast.makeText(Google.this, "Gmail Logged out successfully!", Toast.LENGTH_SHORT).show();
                                            Intent intent = new Intent(Google.this, MainActivity.class);
                                            startActivity(intent);
                                            finish();
                                        }else{
                                            Toast.makeText(Google.this, "Gmail Log out failed!", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                            }
